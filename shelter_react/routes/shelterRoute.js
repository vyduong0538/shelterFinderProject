...
router.get('/', awaitHandlerFactory(shelterController.getAllShelters)); // localhost:3000/api/v1/users
router.get('/shelter/:id', awaitHandlerFactory(shelterController.getShelterById)); // localhost:3000/api/v1/users/id/1
